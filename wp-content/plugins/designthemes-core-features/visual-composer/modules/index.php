...
define( 'DT_VC_CATEGORY', 'KidsWorld' );
...
$attributes = array(
	'type' => 'dropdown',
	'heading' => esc_html__( 'Row stretch', 'kidsworld-core' ),
	'param_name' => 'full_width',
	'value' => array(
		esc_html__( 'Default', 'kidsworld-core' ) => '',
		esc_html__( 'Default (no paddings)', 'kidsworld-core' ) => 'default_no_spaces',
		esc_html__( 'Stretch row', 'kidsworld-core' ) => 'stretch_row',
		esc_html__( 'Stretch row and content', 'kidsworld-core' ) => 'stretch_row_content',
		esc_html__( 'Stretch row and content (no paddings)', 'kidsworld-core' ) => 'stretch_row_content_no_spaces',
	),
	'description' => esc_html__( 'Select stretching options for row and content (Note: stretched may not work properly if parent container has "overflow: hidden" CSS property).', 'kidsworld-core' ),
	'weight' => 1
);
...
$attributes = array(
    ...
    'description' => esc_html__( 'Enter inline styles for this row.', 'kidsworld-core' )
);
vc_add_param( 'vc_row', $attributes );
...
$attributes = array(
    ...
    'description' => esc_html__( 'Enter text color for this row.', 'kidsworld-core' )
);
vc_add_param( 'vc_row', $attributes );
...
$attributes = array(
	'type' => 'dropdown',
	'heading' => esc_html__( 'Spacing', 'kidsworld-core' ),
	'param_name' => 'spacing',
	'value' => array(
		esc_html__( 'Default', 'kidsworld-core' ) => '',
		esc_html__( 'Default (no paddings)', 'kidsworld-core' ) => 'default_no_spaces'
	),
	'description' => esc_html__( 'Default (no paddings) option removes padding of columns inside it.', 'kidsworld-core' ),
	'weight' => 1
);
...
$attributes = array(
	'type' => 'el_id',
	'heading' => esc_html__( 'Column ID', 'kidsworld-core' ),
	'param_name' => 'el_id',
	'description' => sprintf( esc_html__( 'Enter column ID (Note: make sure it is unique and valid according to <a href="%s" target="_blank">w3c specification</a>).', 'kidsworld-core' ), 'http://www.w3schools.com/tags/att_global_id.asp' ),
	'weight' => 1
);
...
$attributes = array(
	'type' => 'dropdown',
	'heading' => esc_html__( 'Content Alignment', 'kidsworld-core' ),
	'param_name' => 'el_align',
	'value' => array( esc_html__('None', 'kidsworld-core') => '', 'Left' => 'left', 'Right' => 'right', 'Center' => 'center', 'Justify' => 'justify' ),
	'description' => esc_html__( 'Select column alignment.', 'kidsworld-core' ),
	'std' => '',
	'weight' => 1
);
vc_add_param( 'vc_column', $attributes );
...
$attributes = array(
    ...
    'heading' => "Inline styles",
    'param_name' => 'addstyles',
    'description' => esc_html__( 'Enter inline styles for this column.', 'kidsworld-core' )
);
vc_add_param( 'vc_column', $attributes );
vc_add_param( 'vc_column_inner', $attributes );
...
$attributes = array(
    ...
    'description' => esc_html__( 'Select type of animation for element to be animated when it "enters" the browsers viewport (Note: works only in modern browsers).', 'kidsworld-core' ),
	'weight' => 1
);
vc_add_param( 'vc_column_inner', $attributes );

// VC Column Text ----------------------------------------------------------------------
$attributes['description'] = esc_html__( 'Enter inline styles for this textblock.', 'kidsworld-core' );
