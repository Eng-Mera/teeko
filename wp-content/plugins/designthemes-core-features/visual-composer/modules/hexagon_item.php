...
function dt_sc_hexagon_item_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Hexagon item", 'kidsworld-core' ),
		"base" => "dt_sc_hexagon_item",
		"icon" => "dt_sc_single_hexagon",
		"category" => DT_VC_CATEGORY,
		'as_child' => array( 'only' => 'dt_sc_hexagon_wrapper' ),
		'description' => esc_html__( 'Hexagon item', 'kidsworld-core' ),
		"params" => array(
			...
			array(
				...
				'description' => esc_html__( 'Enter icon class eg: (icon icon-speedometter or fa fa-home)', 'kidsworld-core' )
			),
		)
	) );
}?>