...
function dt_sc_tab_vc_map() {
	...
	vc_map( array(
		'name' => esc_html__( 'Tab', 'kidsworld-core' ),
		'base' => 'dt_sc_tab',
		...
		'params' => array(
			...
			array(
				'type' => 'tab_id',
				'heading' => esc_html__( 'Tab ID', 'kidsworld-core' ),
				'param_name' => "tab_id"
			),
			...
			array(
				...
				'param_name' => 'title',
				'description' => esc_html__( 'Enter title of tab', 'kidsworld-core' )
			),
			...
			array(
				...
				'description' => esc_html__( 'Enter sub title of tab', 'kidsworld-core' )
			),			
			...
			array(
				...
				'value' => array(
					...
					esc_html__('Custom', 'kidsworld-core') => 'custom',
				)
			),			
			...
			# Custom icon Class
      		array(
      			"type" => "textfield",
      			"heading" => esc_html__( "Icon class name", 'kidsworld-core' ),
