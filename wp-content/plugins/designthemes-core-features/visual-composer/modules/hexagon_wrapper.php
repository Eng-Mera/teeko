...
function dt_sc_hexagon_wrapper_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Hexagon", 'kidsworld-core' ),
		...
		'description' => esc_html__( 'Hexagon wrapper', 'kidsworld-core' ),
		"params" => array(
			...
			array(
				...
				'heading' => esc_html__( 'Extra sub title', 'kidsworld-core' ),
				'description' => esc_html__( 'Enter extra sub title', 'kidsworld-core' )
			),
