...
function dt_sc_event_caption_vc_map() {
	vc_map( array(
		"name" => esc_html__("Event Caption", 'kidsworld-core'),
		"base" => "dt_sc_event_caption",
		"icon" => "dt_sc_event_caption",
		"category" => DT_VC_CATEGORY,
		"description" => esc_html__("Add event caption",'kidsworld-core'),
		"params" => array(
			...
			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Sub Title 1', 'kidsworld-core' ),
			...
			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Sub Title 2', 'kidsworld-core' ),
