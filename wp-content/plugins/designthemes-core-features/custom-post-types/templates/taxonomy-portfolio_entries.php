<?php get_header(); 
  $page_layout = kidsworld_option('pageoptions','portfolio-archives-page-layout');
  ...
  if ( $show_sidebar ):
    ...
    <section id="primary" class="<?php echo esc_attr( $page_layout );?>"><?php
      ...
      $post_layout = kidsworld_option('pageoptions','portfolio-archives-post-layout');
      $post_layout = isset( $post_layout ) ? $post_layout : 'one-half-column';

      $post_style = kidsworld_option('pageoptions','portfolio-archives-post-style');
      $post_style = isset( $post_style ) ? $post_style : 'type1';

      $allow_space = kidsworld_option('pageoptions','portfolio-allow-grid-space');
