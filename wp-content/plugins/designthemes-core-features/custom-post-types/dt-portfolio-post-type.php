	...
	class DTPortfolioPostType {
		...
		function createPostType() {
			...
			if( function_exists( 'kidsworld_opts_get' ) ) {
				$portslug =	kidsworld_opts_get( 'single-portfolio-slug', 'dt_portfolios' );
				$taxslug  =	kidsworld_opts_get( 'portfolio-category-slug', 'portfolio_entries' );
			}

			$labels = array (
					'name' => esc_html__( 'Portfolios', 'kidsworld-core' ),
					'all_items' => esc_html__( 'All Portfolios', 'kidsworld-core' ),
					'singular_name' => esc_html__( 'Portfolio', 'kidsworld-core' ),
					'add_new' => esc_html__( 'Add New', 'kidsworld-core' ),
					'add_new_item' => esc_html__( 'Add New Portfolio', 'kidsworld-core' ),
					'edit_item' => esc_html__( 'Edit Portfolio', 'kidsworld-core' ),
					'new_item' => esc_html__( 'New Portfolio', 'kidsworld-core' ),
					'view_item' => esc_html__( 'View Portfolio', 'kidsworld-core' ),
					'search_items' => esc_html__( 'Search Portfolios', 'kidsworld-core' ),
					'not_found' => esc_html__( 'No Portfolios found', 'kidsworld-core' ),
					'not_found_in_trash' => esc_html__( 'No Portfolios found in Trash', 'kidsworld-core' ),
					'parent_item_colon' => esc_html__( 'Parent Portfolio:', 'kidsworld-core' ),
					'menu_name' => esc_html__( 'Portfolios', 'kidsworld-core' ) ,					
			);
			
			$args = array (
					'labels' => $labels,
					'hierarchical' => false,
					'description' => esc_html__( 'This is custom post type portfolios', 'kidsworld-core' ),
					'supports' => array (
							'title',
							'editor',
							'comments',
			...
			register_taxonomy ( 'portfolio_entries', array (
					...
					"hierarchical" => true,
					"label" => esc_html__( "Categories",'kidsworld-core' ),
					"singular_label" => esc_html__( "Category",'kidsworld-core' ),
		...
		function dt_add_portfolio_meta_box() {
			add_meta_box ( "dt-portfolio-default-metabox", esc_html__( 'Default Options', 'kidsworld-core' ), array (
					$this,
					'dt_default_metabox' 
		...
		function dt_portfolios_edit_columns($columns) {
			...
			$newcolumns = array (
				...
				"dt_portfolio_thumb" => esc_html__("Image", "kidsworld-core"),
				"title" => esc_html__("Title", "kidsworld-core"),
				"author" => esc_html__("Author", "kidsworld-core")
			);
