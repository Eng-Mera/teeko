...
get_header();
    ...
    <section id="primary" class="<?php echo esc_attr( $page_layout );?>"><?php
				...
				<div class="<?php echo esc_attr($temp_class);?>">
					<article id="post-<?php the_ID();?>" <?php post_class('blog-entry '.$post_style.' '.$sticky_class);?>>
                        ...
                        <?php if( $post_style == "entry-date-left"): ?>
                                ...
                                <div class="entry-details">
                                    ...
                                    <?php if( array_key_exists('blog-post-excerpt',$tpl_default_settings) && array_key_exists('blog-post-excerpt-length',$tpl_default_settings) ):?>
                                    		<div class="entry-body"><?php echo kidsworld_excerpt($tpl_default_settings['blog-post-excerpt-length']);?></div>
                                   <?php endif;?>
                        ...
                        <?php elseif( $post_style == "entry-date-author-left"):
                        		$tclass = ( ($show_comment_meta == "hidden" ) && ($show_author_meta == "hidden" ) ) ? "hidden" : ""; ?>
                        ...
                        <?php elseif( $post_style == "default"): # Default Post Style ?>
                        		<div class="entry-details">
                                	<!-- Meta -->
                                	<?php $tclass = ( ($show_comment_meta == "hidden" ) && ($show_author_meta == "hidden" ) ) ? "hidden" : ""; ?>
        ...
        <!-- **Pagination** -->
        <div class="pagination blog-pagination"><?php echo kidsworld_pagination($the_query); ?></div><!-- **Pagination** -->
        <!-- Blog Template Ends -->
