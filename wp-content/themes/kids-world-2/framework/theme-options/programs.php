...
<div id="programs" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        ...
        <ul class="sub-panel"> 
			<li><a href="#tab1"><?php esc_html_e('Programs', 'kids-world');?></a></li>
        </ul>
        ...
        <div id="tab1" class="tab-content">
            ...
            <div class="bpanel-box">
              ...
              <div class="box-title">
                  <h3><?php esc_html_e('Program Archives Page Layout', 'kids-world');?></h3>
              </div>

              <div class="box-content">
                  <h6><?php esc_html_e('Layout', 'kids-world');?></h6>
                  <p class="note no-margin"> <?php esc_html_e("Choose the Program archives page layout Style", 'kids-world');?></p>
                  ...
                  <div class="bpanel-option-set">
                      ...
                      <?php $layout = array('content-full-width'=>'without-sidebar','with-left-sidebar'=>'left-sidebar','with-right-sidebar'=>'right-sidebar','with-both-sidebar'=>'both-sidebar');
                            $v =  kidsworld_option('pageoptions',"program-archives-page-layout");
                  ...
                  $sb_layout = kidsworld_option('pageoptions',"program-archives-page-layout");
                  ...
                  <div id="bpanel-widget-area-options" <?php echo 'class="program-archives-layout" '.$sidebar_both;?>>
                    <div id="left-sidebar-container" class="bpanel-page-left-sidebar" <?php echo ($sidebar_left); ?>>
                        ...
                        <div id="page-commom-sidebar" class="bpanel-sidebar-section custom-box">
                            ...
                            <?php kidsworld_switch("",'pageoptions','show-standard-left-sidebar-for-program-archives'); ?>
                    ...
                    <div id="right-sidebar-container" class="bpanel-page-right-sidebar" <?php echo ($sidebar_right); ?>>
                        ...
                        <div id="page-commom-sidebar" class="bpanel-sidebar-section custom-box">
                            ...
                            <?php kidsworld_switch("",'pageoptions','show-standard-right-sidebar-for-program-archives'); ?>
              ...
              <div class="box-title">
                  <h3><?php esc_html_e('Program Archives Post Layout', 'kids-world');?></h3>
              </div>

              <div class="box-content">
                  <h6><?php esc_html_e('Layout', 'kids-world');?></h6>
                  <p class="note no-margin"><?php esc_html_e("Choose the Post Layout Style in Program Archives", 'kids-world');?></p>
                  <div class="hr_invisible"> </div>
                  <div class="bpanel-option-set">
                      ...
                      <?php $posts_layout = array( 'one-half-column'=>esc_html__("Two posts per row.", 'kids-world'), 'one-third-column' => esc_html__("Three posts per row.", 'kids-world'));
                            $v = kidsworld_option('pageoptions',"program-archives-post-layout");
              ...
              <div class="box-title">
                <h3><?php esc_html_e('Program Custom Fields', 'kids-world');?></h3>
              </div>
              ...
              <div class="box-content">
                  <div class="portfolio-custom-fields">
                    ...
                    <div class="hr_invisible"> </div>
                    <?php $custom_fields = kidsworld_option("pageoptions","program-custom-fields");
              ...
              <div class="box-content">
                <div class="column one-third"><label><?php esc_html_e('Single Program slug', 'kids-world');?></label></div>
                ...
                <div class="column one-third"><label><?php esc_html_e('Program Category slug', 'kids-world');?></label></div>
                <div class="column two-third last">
                  ...
                  <p class="note"><?php esc_html_e('Do not use characters not allowed in links. Use, eg. program-types <br> <b>After made changes save permalinks.</b>', 'kids-world');?></p>
                </div>
                <div class="hr"></div>

                <div class="column one-half">
                  <label><?php esc_html_e('Singular Program Name', 'kids-world');?></label>
                  <div class="clear"></div>
                ...
                <div class="column one-half last">
                  <label><?php esc_html_e('Plural Program Name', 'kids-world');?></label>
                  <div class="clear"></div>
                ...
                <div class="column one-half">
                  <label><?php esc_html_e('Singular Program Category Name', 'kids-world');?></label>
                  <div class="clear"></div>
                  <input name="dttheme[pageoptions][singular-program-tax-name]" type="text" class="medium" value="<?php echo trim(stripslashes(kidsworld_option('pageoptions','singular-program-tax-name')));?>" />
                  <p class="note"><?php esc_html_e('By default "Category". save options & reload.', 'kids-world');?></p>
                  <div class="hr"></div>
                </div>
                <div class="column one-half last">
                  <label><?php esc_html_e('Plural Program Category Name', 'kids-world');?></label>
                  <div class="clear"></div>
                    <input name="dttheme[pageoptions][plural-program-tax-name]" type="text" class="medium" value="<?php echo trim(stripslashes(kidsworld_option('pageoptions','plural-program-tax-name')));?>" />
            ...
            <div class="bpanel-box">
              <div class="box-title">
                <h3><?php esc_html_e('Trainer Custom Fields', 'kids-world');?></h3>
              </div>
              ...
              <div class="box-content">
                  <div class="portfolio-custom-fields">
                    <input type="button" class="black add-custom-field" value="<?php esc_attr_e('Add New Field', 'kids-world');?>" />
                    <div class="hr_invisible"> </div>
                    <?php $custom_fields = kidsworld_option("pageoptions","trainer-custom-fields");
                      $custom_fields = is_array($custom_fields) ? array_filter($custom_fields) : array();
                      $custom_fields = array_unique( $custom_fields);
              ...
              <div class="box-content">
                <div class="column one-half">
                  <label><?php esc_html_e('Singular Trainer Name', 'kids-world');?></label>
                  <div class="clear"></div>
                  <input name="dttheme[pageoptions][singular-trainer-name]" type="text" class="medium" value="<?php echo trim(stripslashes(kidsworld_option('pageoptions','singular-trainer-name')));?>" />
                  <p class="note"><?php esc_html_e('By default "Trainer", save options & reload.', 'kids-world');?></p>
                  <div class="hr"></div>
                </div>
                <div class="column one-half last">
                  <label><?php esc_html_e('Plural Trainer Name', 'kids-world');?></label>
                  <div class="clear"></div>
                  <input name="dttheme[pageoptions][plural-trainer-name]" type="text" class="medium" value="<?php echo trim(stripslashes(kidsworld_option('pageoptions','plural-trainer-name')));?>" />
                  <p class="note"><?php esc_html_e('By default "Trainers". save options & reload.', 'kids-world');?></p>
                  <div class="hr"></div>
                </div>
              </div>
            </div><!-- .bpanel-box end -->
