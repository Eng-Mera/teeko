...
var dtthemeAdmin = {
  ...
  jQuery('.dt-alpha-colorpicker').each(function(){
    jQuery(this).wpColorPicker();
  });
  }, //colorPicker
  ...
  resetConfirm : function (){
    ...
    jQuery('.dttheme-reset-button').click(function(e){
      ...
      if(confirm(objectL10n.resetConfirm)){
    	  ...
    	  var data =  { action : 'kidsworld_backup_and_restore_action', type:'reset_options'};
  ...
  backupOption: function(){
	  jQuery("a#dttheme_backup_button").click(function(e){
		  ...
		  if( ans ){
			 ...
			 var data =  { action : 'kidsworld_backup_and_restore_action', type:'backup_options'};
  ...
  restoreOption : function(){
	  jQuery("a#dttheme_restore_button").click(function(e){
		  ...
		  if( ans ){
			  var data =  { action : 'kidsworld_backup_and_restore_action', type:'restore_options'};
  ...
  importOption : function() {
	  jQuery("a#dttheme_import_button").click(function(e){
		  ...
		  if( ans ){
			  var data =  { action : 'kidsworld_backup_and_restore_action', type:'import_options', data : jQuery("#export_data").val()};
			  jQuery('#ajax-feedback').css({display:'block'});
