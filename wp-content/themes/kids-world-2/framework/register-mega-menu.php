<?php
add_filter( 'wp_edit_nav_menu_walker', 'kidsworld_modify_backend_walker' , 10 );
function kidsworld_modify_backend_walker() {
	return 'KidsWorld_ModifyBackendMenuWalker';
}
/* ---------------------------------------------------------------------------
 * Admin Menu Walker
 * This is copy of wp-admin/includes/nav-menu.php
 * --------------------------------------------------------------------------- */
class KidsWorld_ModifyBackendMenuWalker extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( ! empty( $item->_invalid ) ) {
			...
			$title = sprintf( esc_html__( '%s (Invalid)', 'kids-world' ), $item->title );
		} elseif ( isset( $item->post_status ) && 'draft' == $item->post_status ) {
			$classes[] = 'pending';
			/* translators: %s: title of menu item in draft status */
			$title = sprintf( esc_html__('%s (Pending)', 'kids-world'), $item->title );
		}
		...
		<li id="menu-item-<?php echo esc_attr($item_id); ?>" class="<?php echo esc_attr(implode(' ', $classes )); ?>">
			<dl class="menu-item-bar">
				<dt class="menu-item-handle">
					<span class="item-title"><span class="menu-item-title"><?php echo esc_html( $title ); ?></span> <span class="is-submenu" <?php echo ($submenu_text); ?>><?php esc_html_e( 'sub item', 'kids-world' ); ?></span></span>
					<span class="item-controls">
						...
						<span class="item-order hide-if-js">
							...
							?>" class="item-move-up"><abbr title="<?php esc_attr_e('Move up', 'kids-world'); ?>">&#8593;</abbr></a>
							|
							<a href="<?php
								echo wp_nonce_url(
									add_query_arg(
							...
							?>" class="item-move-down"><abbr title="<?php esc_attr_e('Move down', 'kids-world'); ?>">&#8595;</abbr></a>
						</span>
						<a class="item-edit" id="edit-<?php echo esc_attr($item_id); ?>" title="<?php esc_attr_e('Edit Menu Item', 'kids-world'); ?>" href="<?php
							echo ( isset( $_GET['edit-menu-item'] ) && $item_id == $_GET['edit-menu-item'] ) ? admin_url( 'nav-menus.php' ) : add_query_arg( 'edit-menu-item', $item_id, remove_query_arg( $removed_args, admin_url( 'nav-menus.php#menu-item-settings-' . $item_id ) ) );
						?>"><?php esc_html_e( 'Edit Menu Item', 'kids-world' ); ?></a>
					</span>
				</dt>
			</dl>
			...
			<div class="menu-item-settings" id="menu-item-settings-<?php echo esc_attr($item_id); ?>">
				<?php if( 'custom' == $item->type ) : ?>
					<p class="field-url description description-wide">
						<label for="edit-menu-item-url-<?php echo esc_attr($item_id); ?>">
							<?php esc_html_e( 'URL', 'kids-world' ); ?><br />
				...
				<p class="description description-thin">
					<label for="edit-menu-item-title-<?php echo esc_attr($item_id); ?>">
						<?php esc_html_e( 'Navigation Label', 'kids-world' ); ?><br />
						<input type="text" id="edit-menu-item-title-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-title" name="menu-item-title[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->title ); ?>" />
					</label>
				</p>
				<p class="description description-thin">
					<label for="edit-menu-item-attr-title-<?php echo esc_attr($item_id); ?>">
						<?php esc_html_e( 'Title Attribute', 'kids-world' ); ?><br />
				...
				<p class="field-link-target description">
					<label for="edit-menu-item-target-<?php echo esc_attr($item_id); ?>">
						...
						<?php esc_html_e( 'Open link in a new window/tab', 'kids-world' ); ?>
					</label>
				</p>
				<p class="field-css-classes description description-thin">
					<label for="edit-menu-item-classes-<?php echo esc_attr($item_id); ?>">
						<?php esc_html_e( 'CSS Classes (optional)', 'kids-world' ); ?><br />
						<input type="text" id="edit-menu-item-classes-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-classes" name="menu-item-classes[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( implode(' ', $item->classes ) ); ?>" />
					</label>
				</p>
				<p class="field-xfn description description-thin">
					<label for="edit-menu-item-xfn-<?php echo esc_attr($item_id); ?>">
						<?php esc_html_e( 'Link Relationship (XFN)', 'kids-world' ); ?><br />
						<input type="text" id="edit-menu-item-xfn-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-xfn" name="menu-item-xfn[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->xfn ); ?>" />
					</label>
				</p>
				<p class="field-description description description-wide">
					<label for="edit-menu-item-description-<?php echo esc_attr($item_id); ?>">
						<?php esc_html_e( 'Description', 'kids-world' ); ?><br />
						<textarea id="edit-menu-item-description-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-description" rows="3" cols="20" name="menu-item-description[<?php echo esc_attr($item_id); ?>]"><?php echo esc_html( $item->description ); // textarea_escaped ?></textarea>
						<span class="description"><?php esc_html_e('The description will be displayed in the menu if the current theme supports it.', 'kids-world'); ?></span>
					</label>
				</p>
                ...
                <p class="field-dt-use-as-megamenu description description-thin">
                    <label for="edit-menu-item-dt-use-as-megamenu-<?php echo esc_attr($item_id); ?>">
                        ...
                        <?php esc_html_e( 'Use As Mega Menu' ,  'kids-world' ); ?>
                    </label>
                </p>
                ...
                <p class="field-dt-disable-text description description-thin">
                    <label for="edit-menu-item-dt-disable-text-<?php echo esc_attr($item_id); ?>">
                        ...
                        <?php esc_html_e( 'Disable Text' ,  'kids-world'); ?>
                    </label>
                </p>
                ...
                <p class="field-dt-disable-link description description-thin">
                    <label for="edit-menu-item-dt-disable-link-<?php echo esc_attr($item_id); ?>">
                        ...
                        <?php esc_html_e( 'Disable Link' ,  'kids-world' ); ?>
                    </label>
                </p>
                ...
                <p class="field-dt-fullwidth description description-thin">
                    <label for="edit-menu-item-dt-fullwidth<?php echo esc_attr($item_id); ?>">
                        ...
                        <?php esc_html_e( 'Enable Full width' ,  'kids-world' ); ?>
                    </label>
                </p>
                ...
                <p class="field-dt-submenu-column description description-wide">
                    ...
                    <?php esc_html_e( 'Sub Menu Column Layout' ,  'kids-world' ); ?><br />
                    ...
                    <span class="description"><?php esc_html_e('Select where to align the submenu.',  'kids-world'); ?></span>
                    </label>
                </p>
                ...
                <p class="field-dt-menuicon description description-wide">
                    ...
                    <?php esc_html_e( 'Menu Icon' ,'kids-world');?><br/>
                    ...
                    <span class="description"><?php esc_html_e('Please use font awesome icon ',  'kids-world'); ?></span>
                    </label>
                </p>
                ...
                <p class="field-dt-menu-bg description description-wide">
                    ...
                    <?php esc_html_e( 'Menu Background' ,'kids-world');?><br/>
                    ...
                    <span class="description"><?php esc_html_e('Please use image url',  'kids-world'); ?></span>
                    </label>
                </p>

                <?php $value = get_post_meta( $item->ID, "_dt-menu-color",true); if($value == '') { $value = '#624dd6'; } ?>
                <p class="field-dt-menu-color description description-wide">
                    <label for="edit-menu-item-dt-menu-color-<?php echo esc_attr($item_id); ?>">
                    <?php esc_html_e( 'Menu Color' ,'kids-world');?><br/>
                    <?php echo kidsworld_admin_color_picker_alpha('dt-menu-color['.esc_attr($item_id).']', $value); ?>
                    <span class="description clear"><?php esc_html_e('Please choose color for your menu.',  'kids-world'); ?></span>
                    </label>
                </p>
                ...
                <p class="field-dt-submenu-widget description description-wide">
                    ...
                    <?php esc_html_e( 'Display Widget Area' ,  'kids-world' ); ?><br />
                        <select id="edit-menu-item-dt-submenu-widget-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-dt-submenu-widget" name="dt-submenu-widget[<?php echo esc_attr($item_id); ?>]">
                            <option value=""><?php esc_html_e('Select', 'kids-world');?></option><?php
                    ...
                    <span class="description"><?php esc_html_e('Select widget area to show.',  'kids-world'); ?></span>
                    </label>
                </p>
                ...
                <p class="field-dt-widgetarea-column description description-wide">
                        <label for="edit-menu-item-dt-submenu-column-<?php echo esc_attr($item_id); ?>">
                        <?php esc_html_e( 'Fill Widget Area Layout' ,  'kids-world' ); ?><br />
                        ...
                        <span class="description"><?php esc_html_e('Only works if you choose widget area',  'kids-world'); ?></span>
                        </label>
                </p>
				...
				<p class="field-move hide-if-no-js description description-wide">
					<label>
						<span><?php esc_html_e( 'Move', 'kids-world' ); ?></span>
						<a href="#" class="menus-move-up"><?php esc_html_e( 'Up one', 'kids-world' ); ?></a>
						<a href="#" class="menus-move-down"><?php esc_html_e( 'Down one', 'kids-world' ); ?></a>
						<a href="#" class="menus-move-left"></a>
						<a href="#" class="menus-move-right"></a>
						<a href="#" class="menus-move-top"><?php esc_html_e( 'To the top', 'kids-world' ); ?></a>
					</label>
				</p>
				...
				<div class="menu-item-actions description-wide submitbox">
					<?php if( 'custom' != $item->type && $original_title !== false ) : ?>
						<p class="link-to-original">
							<?php printf( esc_html__('Original: %s', 'kids-world'), '<a href="' . esc_attr( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
						</p>
					<?php endif; ?>
					...
					); ?>"><?php esc_html_e( 'Remove', 'kids-world' ); ?></a> <span class="meta-sep hide-if-no-js"> | </span> <a class="item-cancel submitcancel hide-if-no-js" id="cancel-<?php echo esc_attr($item_id); ?>" href="<?php echo esc_url( add_query_arg( array( 'edit-menu-item' => $item_id, 'cancel' => time() ), admin_url( 'nav-menus.php' ) ) );
						?>#menu-item-settings-<?php echo esc_attr($item_id); ?>"><?php esc_html_e('Cancel', 'kids-world'); ?></a>
				</div>
 ...
 * To Save Menu Items
 * --------------------------------------------------------------------------- */
add_action( 'wp_update_nav_menu_item', 'kidsworld_update_menu_item', 10, 3 );
function kidsworld_update_menu_item( $menu_id, $menu_item_db, $args ) {
	...
	$value = isset( $_POST['dt-menu-color'][$menu_item_db] ) ? $_POST['dt-menu-color'][$menu_item_db] : "";
	update_post_meta( $menu_item_db, "_dt-menu-color",$value);
 ...
 * --------------------------------------------------------------------------- */
class KidsWorld_FrontEndMenuWalker extends Walker {
	...
	function start_lvl( &$output, $depth = 0, $args = array()) {
		...
		if( !($this->mega_active) ){
			$animation = kidsworld_option('layout','menu-hover-style');
			if( !empty( $animation ) ) {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $current_object_id = 0 ) {
		...
		$menu_highligher = '';
		$this->dt_menucolor = get_post_meta( $item->ID, '_dt-menu-color', true);
		if( !empty( $this->dt_menucolor) ){
			$attributes .= ' style="color:'.$this->dt_menucolor.'"';
			$menu_highligher = 'style="text-shadow: 8px 0 '.$this->dt_menucolor.', -8px 0 '.$this->dt_menucolor.', 0px 0 '.$this->dt_menucolor.';"';
		}
		...
		if( empty($nolink) && empty($notext) ){
			...
			$item_output .= '<span class="menu-highlighter" '.$menu_highligher.'></span>';
		...
		if($depth === 0 ) {
			if( $this->mega_active ) {
				...
				$class_names .= ( "true" == kidsworld_option('layout','menu-boxshadow') ) ? ' with-box-shadow ' : '';
				$class_names .= ( "true" == kidsworld_option('layout','menu-title-bg') ) ? ' menu-title-with-bg ' : '';			
				$class_names .= ( "true" == kidsworld_option('layout','menu-links-bg') ) ? ' menu-links-with-bg ' : '';
				$class_names .= ( "true" == kidsworld_option('layout','menu-links-border') ) ? ' menu-links-with-border ' : '';
				$class_names .= ( "true" ==  kidsworld_option('layout','menu-link-arrow') ) ? ' menu-links-with-arrow  '.kidsworld_option('layout','menu-link-arrow-style').' ':'';
