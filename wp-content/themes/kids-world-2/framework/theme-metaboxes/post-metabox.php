<?php
	#Post Meta Box
	add_action("add_meta_boxes", "kidsworld_post_metabox");
	add_action('save_post','kidsworld_post_meta_save');
	function kidsworld_post_metabox(){
		add_meta_box("post-template-meta-container", esc_html__('Post Options', 'kids-world'), "kidsworld_post_settings","post", "normal", "default");
		add_meta_box("post-format-meta-container",esc_html__('Post Format Options', 'kids-world'),"kidsworld_post_format_settings","post","normal","default");
	}

	function kidsworld_post_settings($args){
		global $post;
        ...
        <div class="sub-title custom-box">
            <div class="column one-sixth"><?php esc_html_e( 'Title Background','kids-world');?></div>
        ...
        <div id="page-layout" class="custom-box">
			<div class="column one-sixth">                        
                <label><?php esc_html_e('Layout', 'kids-world');?> </label>
            </div>
			<div class="column five-sixth last">  
                ...
                <p class="note"> <?php esc_html_e("You can choose a perfect layout for your post", 'kids-world');?> </p>
            </div>
        </div><!-- Layout End-->
        ...
        <div class="custom-box">
			<div class="column one-sixth">
        	    <label><?php esc_html_e('Show Featured Image', 'kids-world');?></label>
            </div>
			<div class="column five-sixth last">
                ...
                <p class="note"> <?php esc_html_e('YES! to show featured image', 'kids-world');?> </p>
            </div>
        </div><!-- Featured Image Section End--><?php
		wp_reset_postdata();
    }
	
    function kidsworld_post_format_settings( $args ) {
        global $post; 
        $tpl_default_settings = get_post_meta($post->ID,'_dt_post_settings',TRUE);
        $tpl_default_settings = is_array($tpl_default_settings) ? $tpl_default_settings  : array(); ?>
        ...
        <div id="dt-post-format-gallery">
            <div class="custom-box">
                <div class="column one-sixth"><label><?php esc_html_e('Image Gallery', 'kids-world');?> </label></div>
                <div class="column five-sixth last">
                    <div class="dt-media-btns-container">
                        <a href="#" class="dt-open-media-for-gallery-post button button-primary"><?php esc_html_e( 'Click Here to Add Images', 'kids-world' );?></a>
                    </div>
                    <div class="clear"></div>
        ...
        <div id="dt-post-format-video-audio">
            <div class="custom-box">
                <div class="column one-sixth"><label><?php esc_html_e('oEmbed URL', 'kids-world');?> </label></div>
                <div class="column five-sixth last">
                    ...
                    <p class="note"><?php esc_html_e("Enter a URL that is compatible with WP's built-in oEmbed feature. This setting is used for your video and audio post formats.", 'kids-world');?></p>
                </div>
            </div>

            <div class="custom-box">
                <div class="column one-sixth"><label><?php esc_html_e('Self Hosted URL', 'kids-world');?> </label></div>
                <div class="column five-sixth last">
                    ...
                    <p class="note"><?php esc_html_e("Insert your self hosted video or audio url here.", 'kids-world');?></p>                    
                </div>
            </div>
        </div><?php
    }
	
	function kidsworld_post_meta_save($post_id){
