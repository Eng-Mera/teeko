<?php
	#Event Meta Box
	add_action("add_meta_boxes", "kidsworld_event_metabox");
	add_action('save_post','kidsworld_event_meta_save');
	function kidsworld_event_metabox(){
		add_meta_box("event-template-meta-container", esc_html__('Event Options', 'kids-world'), "kidsworld_event_settings","tribe_events", "normal", "high");
	}

	function kidsworld_event_settings($args){
		global $post;
        ...
        <div id="page-layout" class="custom-box">
			...
			<div class="column five-sixth last">  
                ...
                <p class="note"> <?php esc_html_e("You can choose between a left, right or no sidebar layout.", 'kids-world');?> </p>
            </div>
        </div><!-- Layout End-->
            ...
            <div id="left-sidebar-container" class="page-left-sidebar" <?php echo ($sidebar_left); ?>>
                ...
                <div id="page-commom-sidebar" class="sidebar-section custom-box">
                    ...
                    <div class="column five-sixth last"><?php
                        ...
                        <p class="note"> <?php esc_html_e('Yes! to show "Standard Left Sidebar" on this page.', 'kids-world');?> </p>
                     </div>
            ...
            <div id="right-sidebar-container" class="page-right-sidebar" <?php echo ($sidebar_right); ?>>
                ...
                <div id="page-commom-sidebar" class="sidebar-section custom-box page-right-sidebar">
                    ...
                    <div class="column five-sixth last"><?php 
                        ...
                        <p class="note"> <?php esc_html_e('Yes! to show "Standard Right Sidebar" on this page.', 'kids-world');?> </p>
                     </div>
            ...
            <div class="column five-sixth last"> 
                <select name="dttheme-event-post-style" class="dt-chosen-select">
                    ...
                    <?php $event_styles =  array( 
                              'type1' => esc_html__('Classic','kids-world'),
                              'type2' => esc_html__('Full Width','kids-world'),
                              'type3' => esc_html__('Minimal Tab','kids-world'),
                              'type4' => esc_html__('Clean','kids-world'),
                              'type5' => esc_html__('Modern','kids-world')
                          );
                          foreach( $event_styles as $es => $bv ):
                              echo "<option value='{$es}'".selected($selected,$es,false).">{$bv}</option>";
                          endforeach;?>
                </select>
                <p class="note"> <?php esc_html_e("Your event post page show at most selected style.",'kids-world');?> </p>
            </div>
        </div><!-- Event Style End-->
	...
	function kidsworld_event_meta_save($post_id){
