	...
	<?php if( $post_style == "entry-date-left"):?>
			...
			<div class="entry-details">
				...
				<div class="entry-meta-data">
					...
					<p class="<?php echo esc_attr( $show_category_meta );?> category"><i class="fa fa-th-large"> </i> <?php the_category(', '); ?></p>
				</div><!-- Category & Tag -->

				<?php edit_post_link( esc_html__( ' Edit ','kids-world' ) ); ?>
			</div><!-- .entry-details -->
	...
	<?php else: # Default Post Style ?>
			...
			<div class="entry-details">
				...
				<div class="entry-meta">
					<div class="date <?php echo esc_attr($show_date_meta);?>"><?php esc_html_e('Posted on','kids-world'); echo ' '.get_the_date(get_option('date_format'));?></div>
					<div class="comments <?php echo esc_attr($show_comment_meta);?>"> / <?php
						comments_popup_link('<i class="fa fa-comment"> </i> 0', '<i class="fa fa-comment"> </i> 1', '<i class="fa fa-comment"> </i> %', '', '<i class="fa fa-comment"> </i> 0');?>								
					</div>
					<div class="author <?php echo esc_attr( $show_author_meta );?>">
						/ <i class="fa fa-user"> </i>
						<a href="<?php echo get_author_posts_url(get_the_author_meta('ID'));?>" title="<?php esc_attr_e('View all posts by ', 'kids-world'); echo get_the_author();?>">
...
<?php # Post Author Information Box
	$post_author_box = kidsworld_option('pageoptions','single-post-authorbox');
	if( isset($post_author_box) ):?>
		<div class="dt-sc-hr"></div>
		<div class="dt-sc-clear"></div>
		<section class="author-info">
        	<h2><?php esc_html_e('About Author','kids-world');?></h2>
			<div class="thumb">
...
<?php endif;
	...
	# Related Posts
	$related_post = kidsworld_option('pageoptions','single-post-related');
	...
	#Post Comments
	$post_comment = kidsworld_option('pageoptions','single-post-comments');
